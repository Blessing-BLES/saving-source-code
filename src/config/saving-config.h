/* src/config/saving-config.h.  Generated from saving-config.h.in by configure.  */
/* src/config/saving-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.saving.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Saving Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Saving Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "saving"
