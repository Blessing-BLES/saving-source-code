...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 3080000) {
     nSubsidy = 7 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 3000000) {
     nSubsidy = 10 * COIN;
    }
    ...
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 240000) {
     nSubsidy = 5 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 160000) {
     nSubsidy = 6 * COIN;
    }
    else if (nHeight > Params().LAST_POW_BLOCK() && nHeight > 80000) {
     nSubsidy = 8 * COIN;
    }
